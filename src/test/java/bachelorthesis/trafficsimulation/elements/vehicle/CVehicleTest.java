...
public class CVehicleTest {
    ...
    private int uncliptest( @Nonnull final DoubleMatrix1D p_position_first,
                                          @Nonnull final DoubleMatrix1D p_position,
                                          @Nonnull final DoubleMatrix1D p_position_world,
                                          @Nonnull final Number p_viewrangesize )
    {
        ...
        System.out.println( p_position_first.getQuick( 1 ) + p_viewrangesize.doubleValue() );
        System.out.println( p_position_world.getQuick( 1 ) );
        if ( ( p_position_first.getQuick( 1 ) + p_viewrangesize.doubleValue() ) <= p_position_world.getQuick( 1 ) )
            return 1;

        // if car is in-front of, nothing to do and inside the environment size
        if ( p_position.getQuick( 1 ) >= p_position_first.getQuick( 1 ) )
            return 2;
        ...
        l_project.setQuick( 1, l_project.getQuick( 1 ) + p_position_world.getQuick( 1 ) );
        return 3;
    }
    ...
    private DoubleMatrix1D unclip( @Nonnull final DoubleMatrix1D p_position_first,
                                   @Nonnull final DoubleMatrix1D p_position,
                                   @Nonnull final DoubleMatrix1D p_position_world,
                                   @Nonnull final Number p_viewrangesize )
    {
        return this.unclipforward( p_position_first, p_position, p_position_world, p_viewrangesize );
    }
     ...
     */
    private DoubleMatrix1D unclipforward( @Nonnull final DoubleMatrix1D p_position_first,
                                          @Nonnull final DoubleMatrix1D p_position,
                                          @Nonnull final DoubleMatrix1D p_position_world,
                                          @Nonnull final Number p_viewrangesize )
    {
