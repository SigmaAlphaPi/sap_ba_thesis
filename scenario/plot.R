...
scenarioRawData <- jsonlite::read_json(scenarioFileName)
...
# --- plot for LANE ---
plot(1:configurationData$simulationtime_in_timesteps, vehicleDataList[[1]][[2]], type = "l", xlab="Simulationszeit in h", ylab = "Spurnutzung", ylim=c(0, 1), xaxt = "n")
# --- time axis in hours ---
axis(1, at = seq( 0, configurationData$simulationtime_in_timesteps, by = timeStepwidth_in_minutes/configurationData$timestep_in_minutes ), labels = labelAxisTime )
# --- plot for LANE ---
plot(1:configurationData$simulationtime_in_timesteps, vehicleDataList[[2]][[2]], type = "l", xlab="Simulationszeit in h", ylab = "Spurnutzung", ylim=c(0, 1), xaxt = "n")
# --- time axis in hours ---
axis(1, at = seq( 0, configurationData$simulationtime_in_timesteps, by = timeStepwidth_in_minutes/configurationData$timestep_in_minutes ), labels = labelAxisTime )
