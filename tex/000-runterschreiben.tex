...
Startzustand ist ein allgemeiner Zustand \enquote{Drive/Fahren} (DRI), in dem nichts am Verhalten des Agenten geändert wird.
Von hier aus ist der Zustand \enquote{Accelerate/Beschleunigen} (ACC) zu erreichen, wenn die aktuelle Geschwindigkeit unter der max. zulässigen liegt. 
...
Wird stattdessen zufällig das \enquote{Linger/Trödeln} angestoßen wird der entsprechende Zustand (LIN) erreicht.
Ist Verkehr voraus wird der Zustand \enquote{Decelerate/Verzögern/Bremsen} (DEC) erreicht.
...
Es wurden insgesamt [x]\sa{own: Anzahl} Durchgänge durchgeführt. 
