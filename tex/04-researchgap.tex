...
Nach dem \enquote{Social-Force-Modell} würde dem Fahrzeug \textbf{CIRCLE} wahrscheinlich eine höhere Kraft der entsprechenden Zelle und somit Wahrscheinlichkeit für das Ausscheren berechnet werden.
...
Da das Fahrzeug \textbf{CIRCLE} seine Geschwindigkeit aber nur durch die Zufallsgröße \enquote{Trödeln} um $1$ reduzieren kann, würde es beim Setzen/Fahren auf das gleiche Grid-Feld oder gar davor gesetzt werden. \\
