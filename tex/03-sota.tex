...
\begin{itemize}
	\item \textit{Mikroskopische Modelle} simulieren einzelne Fahrzeug-Fahrer-Einheiten, basierend auf dem Fahrerverhalten. Zwei Modellierungsansätze können hier unterschieden werden: das Fahrzeugfolgemodell (\enquote{car-following model}) und das Zellularautomatenmodell. Zu letzterem später mehr.\sa{hier direkt den Verweis auf das Kapitel rein}
...
\begin{figure}[hptb]
 \centering
 \includegraphics[width=0.65\textwidth]{traffic-simulation}
...
\subparagraph{Erweiterung auf Mehrspurigkeit:}\sa{auf nächste Seite umbrechen}
...
Laut Statistischem Bundesamt gab es 2016 auf Autobahnen 21.193 Unfälle, davon 1.435 innerhalb von Baustellen, siehe \cite[S. 94]{unf2016}. %\footnote{siehe \url{https://www.destatis.de/DE/Publikationen/Thematisch/TransportVerkehr/Verkehrsunfaelle/VerkehrsunfaelleZeitreihenPDF_5462403.pdf?__blob=publicationFile}, abgerufen am 01. Dezember 2017.}\sa{besser eine Referenz} 
Bei den etwa 13000 km Autobahn (\cite[S. 607]{autob2016}) %\footnote{siehe \url{https://www.destatis.de/DE/Publikationen/StatistischesJahrbuch/TransportVerkehr.pdf?__blob=publicationFile}, abgerufen am 01. Dezember 2017.}\sa{besser eine Referenz} 
