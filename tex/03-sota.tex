\section{State-of-the-Art}\sa{Absätze und Leerzeilen zusammenfassen}
\label{sec:sota}
...
\subparagraph{Das Nagel-Schreckenberg-Modell:}\sa{Absatz Einrückung entfernen}
\label{sec:na-sch}
...
\subparagraph{Erweiterung auf Mehrspurigkeit:}\sa{Linebreaks und Einrückungen entfernen}
...
Laut Statistischem Bundesamt gab es 2016 auf Autobahnen 21193 Unfälle, davon 1435 innerhalb von Baustellen.\footnote{siehe \url{https://www.destatis.de/DE/Publikationen/Thematisch/TransportVerkehr/Verkehrsunfaelle/VerkehrsunfaelleZeitreihenPDF_5462403.pdf?__blob=publicationFile}, abgerufen am 01. Dezember 2017.}\sa{besser eine Referenz} %\cite{unf2016}. 
Bei den etwa 13000 km Autobahn\footnote{siehe \url{https://www.destatis.de/DE/Publikationen/StatistischesJahrbuch/TransportVerkehr.pdf?__blob=publicationFile}, abgerufen am 01. Dezember 2017.}\sa{besser eine Referenz} %\cite{autob2016} 
...
\subparagraph{Verwendung im Social-Force-Vehicle-Modell:}\sa{Einrückungen und Leerzeilen reduzieren}
