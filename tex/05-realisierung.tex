\section{Realisierung}\sa{Einrückung und Leerzeilen entfernen}
\label{sec:realisierung}

Die Entwicklung eines eigenen Simulationstools war nicht vorgesehen.
Für die Simulationsläufe wurde die Abwandlung einer Software verwendet, die als \enquote{Traffic Simulation Game} für einen Workshop mit Doktoranden\footnote{\url{https://lightjason.github.io/news/2017-09-workshop/}} erstellt worden war.\sa{klarer formulieren: Wieso war die Entwicklung nicht vorgesehen, aufgrund Deiner Szenarienbeschreibung hätte das System aus dem Workshop die Anforderungen nicht erfüllt, ebenso solltest Du hier noch einmal klar den Bzug zu dem Workshop beschreiben}
...
Umfangreichere Codeänderungen erfolgten durch den Ersteller des Tools, Philipp Kraus.\sa{Das kannst Du so nicht formulieren. Du musst hier wissenschaftlicher schreiben, das ist zu "flach" beschrieben}
...
Der Agent beginnt im Plan \texttt{cruise}, von dem aus alle weiteren Pläne (\texttt{accelerate}, \texttt{linger}, \texttt{decelerate}) gestartet werden.\sa{ein paar Sätze zum Ausführungsmodell des Agenten einfügen}
...
Die realistische Modellierung\sa{Das solltest Du irgendwie stärker hervorheben, das ist ja schon ein Resultat} der Geschwindigkeitsänderungen macht es unmöglich, dass die Fahrzeuge in aufeinanderfolgenden Zellen hinterher fahren.
...
Das Szenario für die Simulation kann über eine YAML-Datei\sa{das fällt hier jetzt vom Himmel, entweder allgemein beschreiben oder eben im Detail am besten an einer konkreten YAML Datei} individuell festgelegt werden.
...
\\
Ausführlich siehe \cref{sec:cellsize-timesteplength}.\sa{einfach \textit{siehe Kapitel XYZ}}
...
\begin{figure}[hptb]
 \centering
 \includegraphics[width=1\textwidth]{negativ-sammeln}
...
\subsubsection{Fahrzeuganzahl}\sa{Referenzen anstatt Footnotes}
...
Ausgangswerte für die Simulation einer 7,5 km langen Strecke sind die folgenden Fahrzeuganzahlen:\sa{besser als Tabelle} 
\begin{itemize}
	\itemsep0em
	\item 34 (A7)
	\item 15 (A38)
...
\paragraph*{Anmerkung zum Teilstück auf der A7}\sa{Leerzeile \& Einrückung entfernen}
\hfill \\
...
Den hier folgenden Ausführungen liegt das beschriebene Szenario zugrunde:\sa{besser als Tabelle}
\begin{itemize}
\itemsep0em
	\item Anzahl Lanes: 1
...
\paragraph*{Zellgröße 7,5 m}\sa{keine leeren Überschriften, Layout hier anpassen} \hfill
...
Die Testläufe für den Einspurfall sollten mit den folgenden Einstellungen erfolgen:\sa{Tabelle aus den Inhalten}
\begin{itemize}
	\itemsep0em
...
\paragraph*{Anpassung der Trödelwahrscheinlichkeit $p_{linger}$}\sa{Absatzumbruch entfernen}
...
\subparagraph*{zu 2.}\sa{auf was bezieht sich das hier genau, richtige Referenz setzen, Layout sollte auch einheitlich gemacht werden} Durch die Inhomogenität der für die Fahrzeuge möglichen Geschwindigkeiten existiert immer (mind.) ein langsamstes Fahrzeug, auf das aufgelaufen wird.
...
\subparagraph*{zu 3.}\sa{auf was bezieht sich das hier genau, richtige Referenz setzen, Layoutout sollte hier auch einheitlich sein und es sollte dann schon mehr als ein Satz sein, beide Paragraph zusammen fassen und mit Referenzen versehen} Aufgrund dieser Feststellung werden die Testläufe mit einer Trödelwahrscheinlichkeit von 0,125 durchgeführt.
...
\cref{figure:testrun-34veh-7ko5km}\sa{own: content}\sa{Referenz funktioniert nicht}
more \cref{figure:a7-34veh-more}

\begin{figure}[hptb]
  \centering 
   \subfigure[Fahrzeugpositionen]{\includegraphics[width=0.95\textwidth]{a7-34veh-position}\label{figure:testrun-34veh-7ko5km-position}} \\
   \subfigure[Geschwindigkeiten]{\includegraphics[width=0.95\textwidth]{a7-34veh-speed}\label{figure:testrun-34veh-7ko5km-speed}}
  \caption{Testlauf: 34 Fahrzeuge, 7,5 km Strecke, 2 Stunden} 
  \label{figure:testrun-34veh-7ko5km}
\end{figure}

\paragraph*{weitere Testläufe mit zunehmender Fahrzeuganzahl}\sa{Überschrift entfernen und in den Text übernehmen}
\hfill \\
...
Erst ab insgesamt 38 Fahrzeugen auf der Strecke bringen die Wechselwirkungen untereinander die entstehende Fahrzeugschlange zum Stoppen. (siehe \cref{figure:short-a7})\sa{Referenz funktioniert nicht + Umbruch entfernen}
...
\subsubsection{Verkehrsmenge A38: 15 Fahrzeuge und Verkehrsmenge A71: 8 Fahrzeuge}\sa{Absatz ist für diese Überschrift zu kurz ggf mit nächsten zusammen fassen}
...
\subsubsection{Beobachtungen}\sa{Linebreaks entferenen}

Während bei der Entwicklung durchaus rückwärts laufende Stauwellen beobachtet werden konnten, siehe z.B. \cref{figure:33veh-1km}\sa{Referenz funktioniert nicht}, ist die Phase der Totalstopps, die dieses Verhalten hervorruft, bei der Simulation des fließenden Verkehrs im allgemeinen nicht vorhanden.
\\
...
<<<<<<< HEAD
\subsubsection{Ursache Zellgröße}\sa{Überschrift ohne Text geht nicht, ggf mit Paragraphs zusammen fassen + Linebreaks entfernen}
=======
...
<<<<<<< HEAD
\subsubsection{Ursache Zeitschrittlänge}\sa{Kapitel ohne Text entfernen oder mit nächste Paragraph zusammenfassen}
=======

\subsubsection{Ursache Zeitschrittlänge}
>>>>>>> 68cb8124d76f1c82a3fad54c3dab92f493677c88

\paragraph*{Worst Case-Analyse für Mindestabstände:}\sa{Einruckung + Linebreaks entfernen}
...
\noindent
Anzahl zu setzender Zellen:\sa{Tabelle ist besser} 
\begin{center}
