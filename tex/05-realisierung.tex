...
\begin{figure}[hptb]
  \centering 
   \subfigure[Fahrzeugpositionen]{\includegraphics[width=0.45\textwidth]{a7-34veh-position}\label{figure:testrun-34veh-7ko5km-position}}\qquad 
   \subfigure[Geschwindigkeiten]{\includegraphics[width=0.45\textwidth]{a7-34veh-speed}\label{figure:testrun-34veh-7ko5km-speed}}
