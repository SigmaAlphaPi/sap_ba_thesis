...
\addcontentsline{toc}{subsection}{weitere Diagramme}


\begin{figure}[hptb]
 \centering
% \includegraphics[width=1\textwidth]{33veh-1km.png}
 \includegraphics[width=1\textwidth]{33veh-1km.pdf}
...
\begin{figure}[hptb]
  \centering
   \subfigure[Stockungen am Anfang der Simulation]{\includegraphics[width=1\textwidth]{a7-34veh-position-2nd}\label{figure:a7-34veh-position-2nd}} \\
   \subfigure[wiederholte Stockungen über die Dauer der Simulation]{\includegraphics[width=1\textwidth]{a7-34veh-position-noflow}\label{figure:a7-34veh-position-noflow}}
  \caption{weitere Simulationsläufe mit 34 Fahrzeugen, A7-Verkehrsmenge}
  \label{figure:a7-34veh-more}
\end{figure}

\vspace{2.5em}
Die Positionsplots weiterer Simulationsläufe mit der A7-Verkehrsmenge in \cref{figure:a7-34veh-more} (siehe \cref{sec:szenario-a7}) zeigen, dass auch mit 34 Fahrzeugen Stockungen auftreten können.
