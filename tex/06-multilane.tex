...
\paragraph*{Ausscherverhalten im \texttt{pullout}-Plan}
\hfill \\
Der Plan für das Ausscheren ist mit insgesamt fünf Bedingungen versehen, siehe \cref{lst:pullout-cond}.
...
\\
Durch die Unterteilung des Sichtfeldes in vier Sektoren, siehe auch \cref{sec:unterteilung-sichtfeld}, wurde die vierte Bedingung notwendig.
\\
...
\hfill \\
Im Plan für das Einscheren sind vier Bedingungen zu beachten, siehe auch \cref{lst:pullin-cond}.
...
\begin{figure}[hptb]
  \centering 
   \subfigure[Spurnutzung, überholendes Fahrzeug]{\includegraphics[width=0.45\textwidth]{multi-overtake-lane}\label{figure:multi-overtake-lane}}\qquad 
   \subfigure[Geschwindigkeit, beide Fahrzeuge]{\includegraphics[width=0.45\textwidth]{multi-overtake-speed}\label{figure:multi-overtake-speed}} \\ 
   \subfigure[Positionen, beide Fahrzeuge]{\includegraphics[width=1\textwidth]{multi-overtake-position}\label{figure:multi-overtake-position}}
...
Diese wird gewöhnlich zur Simulierung von Wachstumsprozessen eingesetzt.
...
%\footnote{siehe \url{https://www.adac.de/_mmm/pdf/fachdossier_ueberholen_auf_landstra\%C3\%9Fen_68414.pdf}, S. 27, abgerufen am 07. März 2018.}
\\
Dies führt zu der Funktion 
\begin{center}
