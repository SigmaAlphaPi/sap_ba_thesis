...
\begin{figure}[hptb]
  \centering 
   \subfigure[1. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run1}\label{figure:run1}}\qquad 
   \subfigure[2. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run2}\label{figure:run2}}\qquad 
   \subfigure[3. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run3}\label{figure:run3}}
...
\begin{figure}[hptb]
  \centering 
   \subfigure[1. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run4}\label{figure:run4}}\qquad 
   \subfigure[2. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run5}\label{figure:run5}}\qquad 
   \subfigure[3. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run6}\label{figure:run6}}
...
Das Plot des zweiten Durchganges zeigt, dass auch in dieser Konstellation Kollisionen stattgefunden haben.
Die Geschwindigkeit des langsameren Fahrzeuges lag in diesem Durchgang in Vergleich zu den anderen beiden um einiges niedriger
Vermutlich waren die Zeiträume zwischen den Steuerungssmöglichkeiten zu groß.

\begin{figure}[hptb]
  \centering 
   \subfigure[1. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run7}\label{figure:run7}}\qquad 
   \subfigure[2. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run8}\label{figure:run8}}\qquad 
   \subfigure[3. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run9}\label{figure:run9}}
...
\begin{figure}[hptb]
  \centering 
   \subfigure[1. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run14}\label{figure:run14}}\qquad 
   \subfigure[2. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run15}\label{figure:run15}}\qquad 
   \subfigure[3. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run16}\label{figure:run16}}
...
\begin{figure}[hptb]
  \centering 
   \subfigure[1. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run17}\label{figure:run17}}\qquad 
   \subfigure[2. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run18}\label{figure:run18}}\qquad 
   \subfigure[3. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run19}\label{figure:run19}}
...
In \cref{figure:run17} konnte das schnellere Fahrzeug wieder mit höherer Geschwindigkeit hinter dem langsameren herfahren, ohne dass ein Raumgewinn passierte.
Der Durchgang im Diagramm in \cref{figure:run18} zeigt wieder das sägezahnähnliche Muster, wie es mit den größeren Zelldimensionen bereits der Fall war.
...
\\
Somit genügte, gewisse Geschwindigkeiten vorrausgesetzt, eine kleine Beschleunigung, um im nachfolgenden Zeitschritt die für die Geschwindigkeit erforderliche Wegstrecke nicht umsetzen zu können.
...
\begin{figure}[hptb]
  \centering 
   \subfigure[1. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run24}\label{figure:run24}}\qquad 
   \subfigure[2. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run25}\label{figure:run25}}\qquad 
   \subfigure[3. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run26}\label{figure:run26}}
...
\begin{figure}[hptb]
  \centering 
   \subfigure[1. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run27}\label{figure:run27}}\qquad 
   \subfigure[2. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run28}\label{figure:run28}}\qquad 
   \subfigure[3. Durchgang]{\includegraphics[width=0.3\textwidth]{speed_run29}\label{figure:run29}}
