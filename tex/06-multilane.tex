...
\begin{figure}[hptb]
  \centering 
   \subfigure[Spurnutzung, überholendes Fahrzeug]{\includegraphics[width=0.3\textwidth]{multi-overtake-lane}\label{figure:multi-overtake-lane}}\qquad 
   \subfigure[Geschwindigkeit, beide Fahrzeuge]{\includegraphics[width=0.3\textwidth]{multi-overtake-speed}\label{figure:multi-overtake-speed}}\qquad 
   \subfigure[Positionen, beide Fahrzeuge]{\includegraphics[width=0.3\textwidth]{multi-overtake-position}\label{figure:multi-overtake-position}}
