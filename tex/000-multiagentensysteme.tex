...
(nach \cite{lightjason-web})\sa{LightJason beschreibt einen BDI-Agenten als parallel ausgeführten regelbasierten Zustandsautomaten, somit eignet das 
grundlegende Ausführungskonzept für den Einsatz im Rahmen eines zellulären Automaten (siehe \ref{sec:ca})}
