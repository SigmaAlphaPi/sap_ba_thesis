\section{Die Simulationsumgebung und \enquote{LightJason}}\sa{Einrückungen und Leerzeilen entfernen}
...
Mehr darüber in \cref{sec:agentspeak}.\sa{streichen}
...
Auf der einen Seite brauchte man eine Syntax um Verhalten zu definieren, auf der anderen Seite musste diese Syntax leicht verständlich und sauber\sa{streichen oder umformulieren} sein.
...
\par\vspace{2.5em}
Für ausführliche Erklärungen zur Syntax, Beispiele usw. sei an dieser Stelle auf die Webseite\footnote{\url{http://www.lightjason.org}} der Entwickler verwiesen.\sa{streichen und dafür eine Referenz einfügen}
