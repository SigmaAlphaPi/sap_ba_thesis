...
\begin{document}
    ...
    \include{tex/thesis/00-title}
    \include{tex/thesis/01-einleitung}
    \input{tex/thesis/02-problemstellung}
    \include{tex/thesis/03-sota} 
    \input{tex/thesis/04-researchgap}
    \include{tex/thesis/05-realisierung}
